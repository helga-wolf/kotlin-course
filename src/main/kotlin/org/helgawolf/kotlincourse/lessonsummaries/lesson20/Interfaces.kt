...
class ElectricKettle(override val applianceType: String) : HouseholdAppliance(""), TemperatureRegulatable, AutomaticShutdown, LightEmitting, WaterStorable, Openable {
